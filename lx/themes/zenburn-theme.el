...
;;;;; hl-line-mode
   `(hl-line-face ((,class (:background ,zenburn-bg-05))
                   (t :weight bold)))
   `(hl-line ((,class (:background ,"gray31")) ; old emacsen
              (t :weight bold)))
;;;;; hl-sexp
...
;;;;; org-mode
   ...
   `(org-level-1 ((t (:height 1.3 :overline "grey" :foreground ,zenburn-orange))))
   `(org-level-2 ((t (:height 1.2 :foreground ,zenburn-green+4))))
   ...
   `(org-block ((,class (:foreground "DeepSkyBlue3"))))
   ...
   `(org-tag ((t (:slant italic :height 0.8 :foreground "thistle4"))))
   `(org-checkbox ((,class (:weight bold  :foreground "green" ))))
   `(org-todo ((,class (:box (:line-width 1 :color "gray31") :foreground "tomato"))))
   `(org-done ((,class (:box (:line-width 1 :color "gray31") :foreground "DodgerBlue" ))))
